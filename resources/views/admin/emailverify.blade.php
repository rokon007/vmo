								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Email List 
											<span class="d-block text-muted pt-2 font-size-sm">Select email address to change</span></h3>
										</div>
			...
			<input   type="text" name="name"  class="form-control form-control-lg" placeholder="Catagori name">
													...
													<div class="form-group">
														...
														<select name="category_id" class="form-control form-control-lg" id="exampleSelectl">
															...
															@foreach($EmailData as $NewEmailData)
                                                            <option value="{{$NewEmailData->name}}" >{{$NewEmailData->name}}</option>
															@endforeach
