...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Create Rewards</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('rewards.index') }}">Rewards list</a></li>
                    <li class="breadcrumb-item active">Create Rewards</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
@endif
										...
										<div class="form-group">
                                            ...
                                            <input type="name" name="dlink" value="{{ old('dlink') }}" class="form-control" placeholder="Enter link">
                                        </div>
