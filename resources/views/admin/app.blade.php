...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 17:29:01 GMT -->
...
<head>
		...
		<meta charset="utf-8" />
		<title>Admin | Vimbiso</title>
		<meta name="description" content="Metronic admin dashboard live demo. Check out all the features of the admin panel. A large number of settings, additional services and widgets." />
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
		<link rel="canonical" href="https://keenthemes.com/metronic" />
		<!------------------------------------------------------------------------------>
		<link href={{asset("../../theme/html/demo1/dist/assets/css/pages/wizard/wizard-25883.css?v=7.2.9")}} rel="stylesheet" type="text/css" />
		<!------------------------------------------------------------------------------->
		    @yield('headlink')
		<!--begin::Fonts-->
		...
		<link href={{asset("../../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle5883.css?v=7.2.9")}} rel="stylesheet" type="text/css" />
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
							<img alt="Logo" src="../theme/html/demo1/dist/assets/media/logos/logo-light2.png" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
...
<!--  XXXXXXXXXXXXXXXXXXXXXXXXXXX  end::Header  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->	




<!--  XXXXXXXXXXXXXXXXXXXXXXXXXXX  begin::Aside Menu  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->	
<!--begin::Aside Menu-->
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <!------------------------------------->								
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Vimbiso</span>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/upload-image')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Business imagess</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/admin/bussinesprofile')}}" class="menu-link">
													...
													<span class="menu-text">Business profiles</span>
												</a>
											</li>
											
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/filemanager')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/admin/claimed-profile')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Claimed profile</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="#" class="menu-link">
													...
													<span class="menu-text">Tagss</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
			            ...
			            <!----------------------------------------->
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/admin/emailverify')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Email addresses</span>
												</a>
											</li>											
										</ul>
									</div>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												...
												<div class="menu-submenu">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="{{url('/admin/title')}}" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Front Page Settings</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
								...
								<!--XXXXXXXXXXXXX BLOG XXXXXXXXXXXXXXX-->
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{url('/admin/blog/category')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-section">
									<h4 class="menu-text">Site administration</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="#" class="menu-link">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/general/minimized-aside.html" class="menu-link">
													...
													<span class="menu-text">Social application tokens</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/general/no-aside.html" class="menu-link">
													...
													<span class="menu-text">Social applications</span>
												</a>
											</li>
...
<!--  XXXXXXXXXXXXXXXXXXXXXXXXXXX  end::Aside  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->

<!--begin::Wrapper-->
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">									


<!--  XXXXXXXXXXXXXXXXXXXXXXXXXXX  -begin::Header  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->
...
<!--XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXend::Quick panel-->
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="symbol symbol-lg-55 symbol-50 symbol-light-success">
											<span class="symbol-label font-size-h7 font-weight-bold">ADMIN</span>
										</span>
									</div>
								</div>
								<!--end::User-->
...
<!--  XXXXXXXXXXXXXXXXXXXXXXXXXXX  begin::Footer  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->
		<!--begin::Footer-->
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://vimbiso.org" target="_blank" class="text-dark-75 text-hover-primary">Vimbiso</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
		...
		<!--begin::Quick Cart-->
<!--XXXXXXXXXXXXXXXXXX    begin::Quick Cart   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX-->		
...
<!--XXXXXXXXXXXXXXXXXX    end::Quick Cart   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX-->
		...
		<script src={{asset("../../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle5883.js?v=7.2.9")}}></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src={{asset("../../theme/html/demo1/dist/assets/js/pages/widgets5883.js?v=7.2.9")}}></script>
		<!--end::Page Scripts-->
		<!--------------------------------------------------------------------------------->
		<script src={{asset("../../theme/html/demo1/dist/assets/js/pages/custom/wizard/wizard-25883.js?v=7.2.9")}}></script>
           @yield('footerlink')
		<script src={{asset("../../theme/html/demo1/dist/assets/js/pages/crud/ktdatatable/base/html-table5883.js?v=7.2.9")}}></script>
		<!--------------------------------------------------------------------------------->
	</body>
	<!--end::Body-->
