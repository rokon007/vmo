								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Select reviews to change 
											<span class="d-block text-muted pt-2 font-size-sm">Reviews</span></h3>
										</div>
										<div class="card-toolbar">
										 <div>
                                             <form method="post" enctype="multipart/form-data" action="{{route('import-reviews')}}">
                                             	@csrf
                                             	<input type="file" class="btn btn-success" name="file">
                                             	<input type="submit" name="upload" value="Upload" class="btn btn-primary">

                                             	<a href="{{route('export-reviews')}}" class="btn btn-primary">Export</a>
									...
									@csrf
															...
															<div class="row">
																...
																<div class="form-group">
																	<label>Name</label>
																	<input type="text" class="form-control form-control-solid form-control-lg" name="name" placeholder=" Name" value="" />
																	<span class="form-text text-muted">Please enter your name.</span>
																</div>
																
																<div class="form-group">
																	<label>Contact</label>
																	<input type="tel" class="form-control form-control-solid form-control-lg" name="contact" placeholder="Contact" value="" />
																	<span class="form-text text-muted">Please enter your phone number.</span>
																</div>
																<div class="form-group">
																	<label>Purchased item</label>
																	<input type="text" class="form-control form-control-solid form-control-lg" name="purchaseditem" placeholder="Purchased item" value="" />
																	<span class="form-text text-muted">Please enter Purchased item.</span>
																</div>
																
																<div class="form-group">
																	<label>Item counter</label>
																	<input type="number" class="form-control form-control-solid form-control-lg" name="itemcounter" placeholder="Item counter" value="" />
																...
																<div class="form-group">
																	...
																	<input type="text" class="form-control form-control-solid form-control-lg" name="branchlocation" placeholder="Branch location" value="" />
																	<span class="form-text text-muted">Please enter your Branch location.</span>
																</div>
																
																<div class="form-group">
																	<label>Review</label>					
																	<textarea class="form-control form-control-solid form-control-lg" name="review" rows="6"></textarea>
																...
																<div class="form-group">
																	...
																	<input type="text" class="form-control form-control-solid form-control-lg" name="typeofpurchase" placeholder="Last Name" value="" />
																	...
																	<div class="col-xl-4">
																		...
																		<div class="form-group">
																			...
																			<textarea class="form-control form-control-solid form-control-lg" name="response" rows="6"></textarea>
