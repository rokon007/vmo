 ...
 <!-- <div class="modal-dialog modal-dialog-centered" role="document">
   ...
   <div class="wrapper1 rounded d-flex align-items-stretch">
        ...
        <div class="contact-form">
            <div class="h3">Request for a contact number</div>
             <form method="POST" action="{{ route('request-contact') }}"> 
            @csrf
              <!--  <div class="form-group pt-3">
                    <label for="message">Message</label>
                    <textarea name="message" class="form-control" required></textarea>
                </div>  -->
				<input type="hidden" name="company_email" value="{{Session::get('contact')}}">
