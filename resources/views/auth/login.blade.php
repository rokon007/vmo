  ...
  <div class="form_container">
    ...
    <div class="row clearfix">
        ...
        <form method="POST" action="{{ route('login') }}">
                        @csrf
                   <!-- <input type="hidden" name="csrfmiddlewaretoken" value="t3x2Uj9lZC0PQ3Gm3weGuLiPhWa5GpXkA3mFJrGeVgiPU5ENqEgNOL8AFlNYyXzV"> -->
      ...
      <div class="form-group p-3"> 
                        <small class="float-left text-dark" style="font-size: medium;">Don't have an account? <a style="color:var(--green)" href="{{url('registration')}}">Register</a></small>
                                ...
                                @if (Route::has('password.request'))
                                    <a class="float-right" style="color:var(--blue)" href="{{ route('password.request') }}">
